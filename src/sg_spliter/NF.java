...
public class NF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SG Line Spliter");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SG_Spliter.setStingValue(jTextPane2.getText());
        SG_Spliter.setTokenValue(jTextField2.getText());
        
        try {
            SG_Spliter.processFn();
        } catch (InterruptedException ex) {
            Logger.getLogger(NF.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTextPane1.setText(SG_Spliter.getStringValue());
        SG_Spliter.outString="";
